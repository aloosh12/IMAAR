...
{
    public abstract class EfCoreCityRepositoryBase : EfCoreRepository<ImaarDbContext, City, Guid>
    {
        public EfCoreCityRepositoryBase(IDbContextProvider<ImaarDbContext> dbContextProvider)
