...
{
    [DbContext(typeof(ImaarDbContext))]
    partial class ImaarDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Imaar.Advertisements.Advertisement", b =>
            {
                b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Imaar.Buildings.Building", b =>
            {
                ...
                b.Property<Guid>("BuildingFacadeId")
                    .HasColumnType("uniqueidentifier");
                ...
                b.Property<Guid>("FurnishingLevelId")
                    .HasColumnType("uniqueidentifier");
                ...
                b.HasIndex("BuildingFacadeId");

                b.HasIndex("FurnishingLevelId");
            ...
            modelBuilder.Entity("Imaar.Buildings.BuildingMainAmenity", b =>
            {
                ...
                b.Property<Guid>("MainAmenityId")
                    .HasColumnType("uniqueidentifier");

                b.HasKey("BuildingId", "MainAmenityId");

                b.HasIndex("MainAmenityId");

                b.HasIndex("BuildingId", "MainAmenityId");
            ...
            modelBuilder.Entity("Imaar.Buildings.BuildingSecondaryAmenity", b =>
            {
                ...
                b.Property<Guid>("SecondaryAmenityId")
                    .HasColumnType("uniqueidentifier");

                b.HasKey("BuildingId", "SecondaryAmenityId");

                b.HasIndex("SecondaryAmenityId");

                b.HasIndex("BuildingId", "SecondaryAmenityId");
     ...
     .HasColumnName("SourceEntityId");
            ...
            modelBuilder.Entity("Imaar.Stories.Story", b =>
            {
                ...
                b.Property<Guid?>("StoryPublisherId")
                    .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Imaar.StoryTicketTypes.StoryTicketType", b =>
            {
                b.Property<Guid>("Id")
                    .HasColumnType("uniqueidentifier");
                ...
                b.ToTable("AppStoryTicketTypes", (string)null);
            });

            modelBuilder.Entity("Imaar.StoryTickets.StoryTicket", b =>
            {
                b.Property<Guid>("Id")
                    .HasColumnType("uniqueidentifier");
                ...
                b.Property<Guid>("StoryAgainstId")
                    .HasColumnType("uniqueidentifier");

                b.Property<Guid>("StoryTicketTypeId")
                    .HasColumnType("uniqueidentifier");
                ...
                b.HasIndex("StoryAgainstId");

                b.HasIndex("StoryTicketTypeId");

                b.HasIndex("TicketCreatorId");

                b.ToTable("AppStoryTickets", (string)null);
            });
            ...
            modelBuilder.Entity("Imaar.Tickets.Ticket", b =>
            {
                ...
                b.Property<Guid>("TicketAgainstId")
                    .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Imaar.Vacancies.Vacancy", b =>
            {
                ...
                b.Property<string>("ExpectedExperience")
                    .HasColumnType("nvarchar(max)")
                    .HasColumnName("ExpectedExperience");
            ...
            modelBuilder.Entity("Imaar.StoryTickets.StoryTicket", b =>
            {
                b.HasOne("Imaar.Stories.Story", null)
                    .WithMany()
                    .HasForeignKey("StoryAgainstId")
                    .OnDelete(DeleteBehavior.NoAction)
                    .IsRequired();

                b.HasOne("Imaar.StoryTicketTypes.StoryTicketType", null)
                    .WithMany()
                    .HasForeignKey("StoryTicketTypeId")
                    .OnDelete(DeleteBehavior.NoAction)
                    .IsRequired();
