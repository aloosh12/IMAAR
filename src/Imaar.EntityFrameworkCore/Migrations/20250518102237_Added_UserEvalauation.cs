...
{
    /// <inheritdoc />
    public partial class Added_UserEvalauation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppUserEvalauations",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserEvalauations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserEvalauations_AppUserProfiles_EvaluatedPersonId",
                        column: x => x.EvaluatedPersonId,
                        principalTable: "AppUserProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppUserEvalauations_AppUserProfiles_Evaluatord",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserEvalauations_EvaluatedPersonId",
                table: "AppUserEvalauations",
                column: "EvaluatedPersonId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserEvalauations_Evaluatord",
                table: "AppUserEvalauations",
                column: "Evaluatord");
        }
