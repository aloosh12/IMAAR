...
namespace Imaar.Migrations
{
    ...
    [Migration("20250609224208_Updated_ImaarService_25061001413775")]
    partial class Updated_ImaarService_25061001413775
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Imaar.Vacancies.VacancyVacancyAdditionalFeature", b =>
                {
                    b.HasOne("Imaar.VacancyAdditionalFeatures.VacancyAdditionalFeature", null)
                        .WithMany()
                        .HasForeignKey("VacancyAdditionalFeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Imaar.Vacancies.Vacancy", null)
                        .WithMany("VacancyAdditionalFeatures")
            ...
            modelBuilder.Entity("Imaar.Vacancies.Vacancy", b =>
                {
                    b.Navigation("VacancyAdditionalFeatures");
                });
