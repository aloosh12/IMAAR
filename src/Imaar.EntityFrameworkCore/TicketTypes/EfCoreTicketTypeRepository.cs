...
{
    public abstract class EfCoreTicketTypeRepositoryBase : EfCoreRepository<ImaarDbContext, TicketType, Guid>
    {
        public EfCoreTicketTypeRepositoryBase(IDbContextProvider<ImaarDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TicketType>> GetListAsync(
            string? filterText = null,
            string? title = null,
            int? orderMin = null,
            int? orderMax = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TicketTypeConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<TicketType> ApplyFilter(
