...
{
    public abstract class EfCoreStoryTicketTypeRepositoryBase : EfCoreRepository<ImaarDbContext, StoryTicketType, Guid>
    {
        public EfCoreStoryTicketTypeRepositoryBase(IDbContextProvider<ImaarDbContext> dbContextProvider)
        ...
        public virtual async Task<List<StoryTicketType>> GetListAsync(
            string? filterText = null,
            string? title = null,
            int? orderMin = null,
            int? orderMax = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? StoryTicketTypeConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<StoryTicketType> ApplyFilter(
            IQueryable<StoryTicketType> query,
            string? filterText = null,
            string? title = null,
            int? orderMin = null,
            int? orderMax = null,
