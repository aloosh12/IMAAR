...
{
    public abstract class EfCoreCategoryRepositoryBase : EfCoreRepository<ImaarDbContext, Category, Guid>
    {
        public EfCoreCategoryRepositoryBase(IDbContextProvider<ImaarDbContext> dbContextProvider)
