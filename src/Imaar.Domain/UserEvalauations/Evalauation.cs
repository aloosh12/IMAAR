...
{
    public abstract class UserEvalauationBase : FullAuditedAggregateRoot<Guid>
    {
        ...
        protected UserEvalauationBase()
        {

        }

        public UserEvalauationBase(Guid id, Guid evaluatord, Guid evaluatedPersonId, int speedOfCompletion, int dealing, int cleanliness, int perfection, int price)
        {
